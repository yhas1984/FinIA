...
class Migration8To9Test {
    ...
    @Test
    fun migrates_v8_schema_and_keeps_existing_data() {
        context.openOrCreateDatabase(databaseName, Context.MODE_PRIVATE, null).use { db ->
            db.execSQL("""
                CREATE TABLE `invoices` (
                    ...
                    `tipo` TEXT NOT NULL, `categoria` TEXT, `moneda` TEXT NOT NULL,
            ...
            db.execSQL("""
                CREATE TABLE `incomes` (
                    ...
                    `fuente` TEXT, `categoria` TEXT, `ivaPercent` REAL NOT NULL,
            ...
            """.trimIndent())
            db.execSQL("INSERT INTO `invoices` VALUES (1, 1000, 'Proveedor X', 'GASTO', 'Alimentación', 'EUR', 121.0, 21.0, 0.0, 'ES', NULL, NULL, NULL, 'drive-1', 'https://drive', 1, NULL, NULL, 10, 20)")
            db.execSQL("INSERT INTO `incomes` VALUES (1, 2000, 'Sueldo', 1000.0, 1000.0, 1000.0, 'EUR', NULL, 'Nómina', 0.0, 0.0, NULL, NULL, 11, 22)")
        ...
        db.openHelper.writableDatabase.use { sqlite ->
            ...
            sqlite.query("SELECT concepto, categoria, subcategoria FROM incomes WHERE id=1").use { c ->
                ...
                assertEquals("Nómina", c.getString(1))
                assertNull(c.getString(2))
            }
